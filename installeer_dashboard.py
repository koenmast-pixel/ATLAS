#!/usr/bin/env python3
"""Schrijft src/Atlas.jsx weg. Draai: python3 installeer_dashboard.py"""
from pathlib import Path

CODE = r"""/*  ATLAS — dashboard
 *
...
Path("src/Atlas.jsx").write_text(CODE, encoding="utf-8")
print(f"  src/Atlas.jsx geschreven: {len(CODE.splitlines())} regels")
